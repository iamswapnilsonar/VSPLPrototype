...
public class JewellerySetScreenActivity extends BaseActivity implements OnClickListener{

	public JewellerySetScreenActivity() {
		super(R.string.jewellery_set_activity);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jewellery_set_activity);
		initUI();
	}
