...
public class ProductGalleryScreenActivity extends BaseActivity implements OnClickListener{
	
	public ProductGalleryScreenActivity() {
		super(R.string.product_gallery_activity);
