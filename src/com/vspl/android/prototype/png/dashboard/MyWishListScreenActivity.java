...
public class MyWishListScreenActivity extends BaseActivity implements OnClickListener{

	public MyWishListScreenActivity() {
		super(R.string.my_whishlist_activity);
