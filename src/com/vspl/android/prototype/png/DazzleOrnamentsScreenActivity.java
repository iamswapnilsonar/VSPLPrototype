...
public class DazzleOrnamentsScreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Get the absoulte layout height according to the device screen density to set the layout.
	...
	private void getImageLayout(Bitmap p_bitmap) {
		...
		m_ivtmpImage.setImageBitmap(Bitmap.createScaledBitmap(p_bitmap, 90, 90, true));
						...
						if (newDist > 0.0f) {
							...
							if (m_absLayout.getBottom() <= (m_ivImage.getBottom()) 
								...
								m_layoutparams = new AbsoluteLayout.LayoutParams(
										AbsoluteLayout.LayoutParams.WRAP_CONTENT,
										AbsoluteLayout.LayoutParams.WRAP_CONTENT, m_absLayout.getLeft(), m_absLayout.getTop());
								
								m_absLayout.setLayoutParams(m_layoutparams);
								
								((Button) m_absLayout.getChildAt(0)).setLayoutParams(new AbsoluteLayout.LayoutParams(
								...
								((Button) m_absLayout.getChildAt(2))
										.setLayoutParams(new AbsoluteLayout.LayoutParams(
												m_deleteEditHeightwidth, m_deleteEditHeightwidth, m_widthDelete, m_widthDelete));
